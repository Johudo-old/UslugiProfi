...
class AnnouncementsView(APIView):
    ...
    def post(self, request):
        ...
        if request.data["price_type"] == PriceTypeEnum.RANGE.name and int(request.data["lower_price"]) >= int(
            request.data["upper_price"]
        ):
...
class AnnouncementByIdView(APIView):
    ...
    def get(self, request, id):
        ...
        serializer = GetAnnouncementsSeriaizer(announcement, context={"request": request})
